...
INSERT INTO customShop (copyright_text, description, slogan, currency_symbol) VALUES ('© 2026 EviMerce','Entra en <a href="/admin">/admin</a> para configurar tu tienda!!! <br><br><br> Usuario: admin <br> Contrasena: admin', 'Una tienda muy chula.', '€');