...
?>
<div class="col">
    <div class="card pt-4" style="display: flex; flex-direction:column; place-items:center; justify-content: center; height:95%">
        ...
        <div class="card-footer border-top-0 bg-transparent p-2" style="width:100%;justify-content: start; place-items:start;">
            <div class="text-center text-xs">
                <a id="add-to-cart-<?php echo $data->id ?>" class="<?php echo ($data->stock <= 0) ? 'text-white btn-disabled btn-secondary disabled' : '' ?> btn btn-outline btn-primary text-xs" style="display:flex; flex-direction:row; gap:4px; place-items:center; justify-content:center; text-align:center;">
