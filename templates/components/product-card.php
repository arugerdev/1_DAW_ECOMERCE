            ...
            <div class="card-body p-0 px-2" style="width: 100%;">
                <div class="text-start text-secondary w-100">
                    ...
                    <?php if ($data->on_sale == 1): ?>
                        ...
                        <p class="text-success p-0 m-0 text-md"><?php echo number_format($data->price - ($data->price * $data->sale_discound / 100), 2)  ?> <?php echo $_GET["CURRENCY_SYMBOL"] ?></p>
                    <?php endif ?>

                    <?php if (!$data->on_sale == 1): ?>
                        <br>
                        <p class="text-success p-0 m-0"><?php echo number_format($data->price, 2) ?> <?php echo $_GET["CURRENCY_SYMBOL"] ?></p>
                    <?php endif ?>
                </div>
