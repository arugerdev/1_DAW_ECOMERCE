        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="py-0 px-0 mt-4 price-contrast" data-originalcolor="#28a745" data-color="<?php echo SHOP_DATA->secondary_color ?>">
                    ...
                    echo '<h2 class="mb-0 '  . ($data->on_sale ? 'text-md text-danger danger color-danger" style="text-decoration: line-through;"' : 'price-contrast" data-originalcolor="#28a745" data-color=' . SHOP_DATA->secondary_color) .  '>' . number_format($data->w_tax_price, 2) . SHOP_DATA->currency_symbol . '</h2>' .
                        ($data->on_sale ? ('<h2 class="mb-0 text-xl price-contrast" data-originalcolor="#28a745" data-color="' . SHOP_DATA->secondary_color . '" >' .  (number_format(($data->w_tax_price - (($data->w_tax_price * $data->sale_discound) / 100)), 2)) . SHOP_DATA->currency_symbol . '</h2>') : '') .
                        '<h4 class="mt-0">
